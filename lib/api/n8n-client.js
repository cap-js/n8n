...
const { buildWebhookHeaders } = require("./connection")
 ...
 * timeout is provided, the built-in defaults kick in.
 */
 ...
 *   2. `X-N8N-API-KEY` - the n8n instance's own auth. Workflow authors must
 *      wire a Header auth credential with this name on the Webhook node.
 */
