 ...
 *   { baseUrl, apiKey, authHeaders, webhookAuthHeaders }
 *
 ...
 *   2) `credentials.{url, apiKey, webhookAuth}`.
 *
 * Throws when neither is set. Plugin behavior flags such as
 * `useTestWebhook` are not credentials and live at `cds.requires.n8n.*`,
 * consumed directly by their call site.
 */
